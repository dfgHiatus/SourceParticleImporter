...
internal class RendererDefinition
{
...
{
    internal static List<RendererDefinition> Setup(ElementArray constraintArray)
    {
        List<RendererDefinition> result = new();
        foreach (var element in constraintArray)
        {
            RendererDefinition r = new RendererDefinition();
