...
public class DmeParticleSystemDefinition
{
    public Guid Id { get; set; }
    public string Name { get; set; }
    public List<DmeParticleOperator> Renderers { get; set; }
    public List<DmeParticleOperator> Operators { get; set; }
    public List<DmeParticleOperator> Initializers { get; set; }
    public List<DmeParticleOperator> Emitters { get; set; }
    public List<DmeParticleOperator> Children { get; set; }
    public List<DmeParticleOperator> Forces { get; set; }
